...
#
##############################
package Bio::MAGE::QuantitationType::SpecializedQuantitationType;
...
$VERSION = q[$Id: SpecializedQuantitationType.pm,v 1.4 2002/10/08 23:29:34 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::QuantitationType::SpecializedQuantitationType
...
From the MAGE-OM documentation for the C<SpecializedQuantitationType> class:
...
Bio::MAGE::QuantitationType::SpecializedQuantitationType has the following super classes
...
instance of the class via the Bio::MAGE::QuantitationType::SpecializedQuantitationType->methodname() syntax.
...
Returns the full class name for this class, Bio::MAGE::QuantitationType::SpecializedQuantitationType.

=cut

sub class_name {
  return q[Bio::MAGE::QuantitationType::SpecializedQuantitationType];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::QuantitationType::SpecializedQuantitationType.
...
Bio::MAGE::QuantitationType::SpecializedQuantitationType: has the following attribute accessor methods:
