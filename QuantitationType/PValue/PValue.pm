...
$VERSION = q[$Id: PValue.pm,v 1.4 2002/10/08 23:29:34 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::QuantitationType::PValue
...
Bio::MAGE::QuantitationType::PValue has the following super classes
...
Returns the full class name for this class, Bio::MAGE::QuantitationType::PValue.

=cut

sub class_name {
  return q[Bio::MAGE::QuantitationType::PValue];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::QuantitationType::PValue.
...
Bio::MAGE::QuantitationType::PValue: has the following attribute accessor methods:
