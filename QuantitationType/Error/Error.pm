...
$VERSION = q[$Id: Error.pm,v 1.4 2002/10/08 23:29:33 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::QuantitationType::Error
...
Bio::MAGE::QuantitationType::Error has the following super classes
...
Returns the full class name for this class, Bio::MAGE::QuantitationType::Error.

=cut

sub class_name {
  return q[Bio::MAGE::QuantitationType::Error];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::QuantitationType::Error.
...
Bio::MAGE::QuantitationType::Error: has the following attribute accessor methods:
