...
#
##############################
package Bio::MAGE::QuantitationType::Ratio;
...
$VERSION = q[$Id: Ratio.pm,v 1.4 2002/10/08 23:29:34 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::QuantitationType::Ratio
...
From the MAGE-OM documentation for the C<Ratio> class:
...
instance of the class via the Bio::MAGE::QuantitationType::Ratio->methodname() syntax.
...
sub class_name {
  return q[Bio::MAGE::QuantitationType::Ratio];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::QuantitationType::Ratio.
