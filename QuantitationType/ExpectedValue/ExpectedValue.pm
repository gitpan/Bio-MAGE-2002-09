...
#
##############################
package Bio::MAGE::QuantitationType::ExpectedValue;
...
@ISA = qw(Bio::MAGE::Base Bio::MAGE::QuantitationType::ConfidenceIndicator Exporter);
$VERSION = q[$Id: ExpectedValue.pm,v 1.4 2002/10/08 23:29:33 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::QuantitationType::ExpectedValue
...
From the MAGE-OM documentation for the C<ExpectedValue> class:
...
Bio::MAGE::QuantitationType::ExpectedValue has the following super classes
...
instance of the class via the Bio::MAGE::QuantitationType::ExpectedValue->methodname() syntax.
...
Returns the full class name for this class, Bio::MAGE::QuantitationType::ExpectedValue.

=cut

sub class_name {
  return q[Bio::MAGE::QuantitationType::ExpectedValue];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::QuantitationType::ExpectedValue.
...
sub superclasses {
  my @list = ('Bio::MAGE::QuantitationType::ConfidenceIndicator');
  return @list;
}
...
Bio::MAGE::QuantitationType::ExpectedValue: has the following attribute accessor methods:
