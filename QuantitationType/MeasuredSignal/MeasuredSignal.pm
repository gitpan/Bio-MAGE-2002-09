...
#
##############################
package Bio::MAGE::QuantitationType::MeasuredSignal;
...
$VERSION = q[$Id: MeasuredSignal.pm,v 1.4 2002/10/08 23:29:34 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::QuantitationType::MeasuredSignal
...
Bio::MAGE::QuantitationType::MeasuredSignal has the following super classes
...
instance of the class via the Bio::MAGE::QuantitationType::MeasuredSignal->methodname() syntax.
...
Returns the full class name for this class, Bio::MAGE::QuantitationType::MeasuredSignal.

=cut

sub class_name {
  return q[Bio::MAGE::QuantitationType::MeasuredSignal];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::QuantitationType::MeasuredSignal.
...
Bio::MAGE::QuantitationType::MeasuredSignal: has the following attribute accessor methods:
