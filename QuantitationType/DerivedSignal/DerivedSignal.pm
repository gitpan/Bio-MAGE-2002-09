...
$VERSION = q[$Id: DerivedSignal.pm,v 1.4 2002/10/08 23:29:33 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::QuantitationType::DerivedSignal
...
Bio::MAGE::QuantitationType::DerivedSignal has the following super classes
...
Returns the full class name for this class, Bio::MAGE::QuantitationType::DerivedSignal.

=cut

sub class_name {
  return q[Bio::MAGE::QuantitationType::DerivedSignal];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::QuantitationType::DerivedSignal.
...
Bio::MAGE::QuantitationType::DerivedSignal: has the following attribute accessor methods:
