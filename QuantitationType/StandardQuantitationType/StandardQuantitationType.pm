...
#
##############################
package Bio::MAGE::QuantitationType::StandardQuantitationType;
...
@ISA = qw(Bio::MAGE::Base Bio::MAGE::QuantitationType::QuantitationType Exporter);
$VERSION = q[$Id: StandardQuantitationType.pm,v 1.5 2002/10/08 23:29:34 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::QuantitationType::StandardQuantitationType
...
From the MAGE-OM documentation for the C<StandardQuantitationType> class:
...
Bio::MAGE::QuantitationType::StandardQuantitationType has the following super classes
...
Bio::MAGE::QuantitationType::StandardQuantitationType has the following subclasses

=over 


=item * Bio::MAGE::QuantitationType::Failed


=item * Bio::MAGE::QuantitationType::MeasuredSignal


=item * Bio::MAGE::QuantitationType::Ratio


=item * Bio::MAGE::QuantitationType::PresentAbsent


=item * Bio::MAGE::QuantitationType::DerivedSignal
...
instance of the class via the Bio::MAGE::QuantitationType::StandardQuantitationType->methodname() syntax.
...
Returns the full class name for this class, Bio::MAGE::QuantitationType::StandardQuantitationType.

=cut

sub class_name {
  return q[Bio::MAGE::QuantitationType::StandardQuantitationType];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::QuantitationType::StandardQuantitationType.
...
sub subclasses {
  my @list = ('Bio::MAGE::QuantitationType::Failed', 'Bio::MAGE::QuantitationType::MeasuredSignal', 'Bio::MAGE::QuantitationType::Ratio', 'Bio::MAGE::QuantitationType::PresentAbsent', 'Bio::MAGE::QuantitationType::DerivedSignal', 'Bio::MAGE::QuantitationType::ConfidenceIndicator');
  return @list;
}
...
sub superclasses {
  my @list = ('Bio::MAGE::QuantitationType::QuantitationType');
  return @list;
}
...
Bio::MAGE::QuantitationType::StandardQuantitationType: has the following attribute accessor methods:
...
sub initialize {
  carp "Bio::MAGE::QuantitationType::StandardQuantitationType::initialize: abstract base classes should not be instantiated";
}
