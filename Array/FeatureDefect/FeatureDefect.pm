...
$VERSION = q[$Id: FeatureDefect.pm,v 1.4 2002/08/24 16:12:11 jason_e_stewart Exp $];
...
Sets the value of the feature association (from C<Bio::MAGE::Array::FeatureDefect>).


=item * positionDelta

Sets the value of the positionDelta association (from C<Bio::MAGE::Array::FeatureDefect>).


=item * defectType

Sets the value of the defectType association (from C<Bio::MAGE::Array::FeatureDefect>).
...
sub association_methods {
  my $class = shift;
  my @list = ('feature', 'positionDelta', 'defectType');
  if ($class->superclasses()) {
    foreach ($class->superclasses()) {
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'Indicates the type of defect (e.g. a missing feature or a moved feature).',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'How the feature deviates in position from the ArrayDesign.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'feature',
          bless( {
                   ...
                   '__RANK' => '3',
                   '__DESCRIPTION' => 'The feature that was manufactured defectively.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
