...
$VERSION = q[$Id: ManufactureLIMSBiomaterial.pm,v 1.3 2002/06/17 21:11:33 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::Array::ManufactureLIMSBiomaterial
...
sub class_name {
  return q[Bio::MAGE::Array::ManufactureLIMSBiomaterial];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::Array::ManufactureLIMSBiomaterial.
...
sub superclasses {
  my @list = ('Bio::MAGE::Array::ManufactureLIMS');
  return @list;
}
...
From the MAGE-OM documentation for the C<bioMaterialPlateCol> attribute:
