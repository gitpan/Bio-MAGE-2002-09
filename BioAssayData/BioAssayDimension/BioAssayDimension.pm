...
$VERSION = q[$Id: BioAssayDimension.pm,v 1.4 2002/08/24 16:12:15 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::BioAssayData::BioAssayDimension
...
=head2 SYNOPSIS
  ...
  my $bioassaydimension = Bio::MAGE::BioAssayData::BioAssayDimension->new(bioAssays=>$bioAssays_value);

    # setting and retrieving object associations
  my $bioAssays_val = $bioassaydimension->bioAssays();
  $bioassaydimension->bioAssays($value);
...
Bio::MAGE::BioAssayData::BioAssayDimension has the following super classes
...
Sets the value of the bioAssays association (from C<Bio::MAGE::BioAssayData::BioAssayDimension>).
...
Returns the full class name for this class, Bio::MAGE::BioAssayData::BioAssayDimension.

=cut

sub class_name {
  return q[Bio::MAGE::BioAssayData::BioAssayDimension];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::BioAssayData::BioAssayDimension.
...
Bio::MAGE::BioAssayData::BioAssayDimension: has the following attribute accessor methods:
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The BioAssays for this Dimension',
                   '__ORDERED' => 1
...
=item $bioassaydimension->addBioAssays(@vals)
