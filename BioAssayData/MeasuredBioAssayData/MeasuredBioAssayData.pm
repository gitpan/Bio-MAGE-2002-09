...
#
##############################
package Bio::MAGE::BioAssayData::MeasuredBioAssayData;
...
$VERSION = q[$Id: MeasuredBioAssayData.pm,v 1.3 2002/06/17 21:11:37 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::BioAssayData::MeasuredBioAssayData
...
From the MAGE-OM documentation for the C<MeasuredBioAssayData> class:
...
Bio::MAGE::BioAssayData::MeasuredBioAssayData has the following super classes
...
instance of the class via the Bio::MAGE::BioAssayData::MeasuredBioAssayData->methodname() syntax.
...
Returns the full class name for this class, Bio::MAGE::BioAssayData::MeasuredBioAssayData.

=cut

sub class_name {
  return q[Bio::MAGE::BioAssayData::MeasuredBioAssayData];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::BioAssayData::MeasuredBioAssayData.
...
Bio::MAGE::BioAssayData::MeasuredBioAssayData: has the following attribute accessor methods:
