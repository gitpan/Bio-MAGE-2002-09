...
#
##############################
package Bio::MAGE::BioAssayData::ReporterDimension;
...
$VERSION = q[$Id: ReporterDimension.pm,v 1.4 2002/08/24 16:12:17 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::BioAssayData::ReporterDimension
...
=head2 SYNOPSIS
  ...
  my $reporterdimension = Bio::MAGE::BioAssayData::ReporterDimension->new(reporters=>$reporters_value);

    # setting and retrieving object associations
  my $reporters_val = $reporterdimension->reporters();
  $reporterdimension->reporters($value);


=head2 DESCRIPTION

From the MAGE-OM documentation for the C<ReporterDimension> class:
...
Bio::MAGE::BioAssayData::ReporterDimension has the following super classes
...
instance of the class via the Bio::MAGE::BioAssayData::ReporterDimension->methodname() syntax.
...
Sets the value of the reporters association (from C<Bio::MAGE::BioAssayData::ReporterDimension>).
...
Returns the full class name for this class, Bio::MAGE::BioAssayData::ReporterDimension.

=cut

sub class_name {
  return q[Bio::MAGE::BioAssayData::ReporterDimension];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::BioAssayData::ReporterDimension.
...
Bio::MAGE::BioAssayData::ReporterDimension: has the following attribute accessor methods:
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The reporters for this dimension.',
                   '__ORDERED' => 1
...
Bio::MAGE::BioAssayData::ReporterDimension: has the following association accessor methods:
...
=item $array_ref = $reporterdimension->setReporters($array_ref)
...
=item $array_ref = $reporterdimension->getReporters()
...
=item $reporterdimension->addReporters(@vals)
