...
$VERSION = q[$Id: BioAssayData.pm,v 1.4 2002/08/24 16:12:15 jason_e_stewart Exp $];
...
=head2 SYNOPSIS
  ...
  my $bioassaydata = Bio::MAGE::BioAssayData::BioAssayData->new(designElementDimension=>$designElementDimension_value,
			bioAssayDimension=>$bioAssayDimension_value,
			bioDataValues=>$bioDataValues_value,
			quantitationTypeDimension=>$quantitationTypeDimension_value,
			summaryStatistics=>$summaryStatistics_value);
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'Statistics on the Quality of the BioAssayData.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'The BioAssays of the BioAssayData.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          ...
          bless( {
                   ...
                   '__RANK' => '3',
                   '__DESCRIPTION' => 'The DesignElements of the BioAssayData.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          ...
          bless( {
                   ...
                   '__RANK' => '4',
                   '__DESCRIPTION' => 'The QuantitationTypes of the BioAssayData.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'bioDataValues',
          bless( {
                   ...
                   '__RANK' => '5',
                   '__DESCRIPTION' => 'The data values of the BioAssayData.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
