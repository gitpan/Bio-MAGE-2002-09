...
$VERSION = q[$Id: DesignElementMap.pm,v 1.4 2002/08/24 16:12:16 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::BioAssayData::DesignElementMap
...
Bio::MAGE::BioAssayData::DesignElementMap has the following super classes
...
Returns the full class name for this class, Bio::MAGE::BioAssayData::DesignElementMap.

=cut

sub class_name {
  return q[Bio::MAGE::BioAssayData::DesignElementMap];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::BioAssayData::DesignElementMap.
...
sub subclasses {
  my @list = ('Bio::MAGE::DesignElement::CompositeCompositeMap', 'Bio::MAGE::DesignElement::ReporterCompositeMap', 'Bio::MAGE::DesignElement::FeatureReporterMap');
  return @list;
}
...
Bio::MAGE::BioAssayData::DesignElementMap: has the following attribute accessor methods:
...
sub initialize {
  carp "Bio::MAGE::BioAssayData::DesignElementMap::initialize: abstract base classes should not be instantiated";
}
