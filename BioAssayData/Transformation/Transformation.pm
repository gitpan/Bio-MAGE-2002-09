...
$VERSION = q[$Id: Transformation.pm,v 1.4 2002/08/24 16:12:17 jason_e_stewart Exp $];
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The BioAssayData sources that the Transformation event uses to produce the target DerivedBioAssayData.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__RANK' => '3',
                   '__DESCRIPTION' => 'The collection of mappings for the QuantitationTypes.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          ...
          bless( {
                   ...
                   '__RANK' => '4',
                   '__DESCRIPTION' => 'The collection of mappings for the DesignElements.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'bioAssayMapping',
          bless( {
                   ...
                   '__RANK' => '5',
                   '__DESCRIPTION' => 'The collection of mappings for the BioAssays.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
...
sub setQuantitationTypeMapping {
  my $self = shift;
  croak(__PACKAGE__ . "::setQuantitationTypeMapping: no arguments passed to setter")
    unless @_;
...
sub setDerivedBioAssayDataTarget {
  my $self = shift;
  croak(__PACKAGE__ . "::setDerivedBioAssayDataTarget: no arguments passed to setter")
    unless @_;
...
sub setBioAssayDataSources {
  my $self = shift;
  croak(__PACKAGE__ . "::setBioAssayDataSources: no arguments passed to setter")
    unless @_;
  croak(__PACKAGE__ . "::setBioAssayDataSources: too many arguments passed to setter")
    if @_ > 1;
  my $val = shift;
...
sub addBioAssayDataSources {
  ...
  my @vals = @_;
    foreach my $val (@vals) {
    croak(__PACKAGE__ . "::addBioAssayDataSources: wrong type: " . ref($val) . " expected Bio::MAGE::BioAssayData::BioAssayData")
      unless UNIVERSAL::isa($val,'Bio::MAGE::BioAssayData::BioAssayData');
  }
