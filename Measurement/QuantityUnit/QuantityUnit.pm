...
$VERSION = q[$Id: QuantityUnit.pm,v 1.3 2002/06/17 21:11:41 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::Measurement::QuantityUnit
...
=head2 SYNOPSIS
  ...
  my $quantityunit = Bio::MAGE::Measurement::QuantityUnit->new(unitNameCV=>$unitNameCV_value);

    # setting and retrieving object attributes
  my $unitNameCV_val = $quantityunit->unitNameCV();
  $quantityunit->unitNameCV($value);
...
Bio::MAGE::Measurement::QuantityUnit has the following super classes
...
Sets the value of the unitNameCV attribute (from C<Bio::MAGE::Measurement::QuantityUnit>).
...
Returns the full class name for this class, Bio::MAGE::Measurement::QuantityUnit.

=cut

sub class_name {
  return q[Bio::MAGE::Measurement::QuantityUnit];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::Measurement::QuantityUnit.
...
Bio::MAGE::Measurement::QuantityUnit: has the following attribute accessor methods:
