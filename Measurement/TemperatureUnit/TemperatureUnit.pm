...
#
##############################
package Bio::MAGE::Measurement::TemperatureUnit;
...
$VERSION = q[$Id: TemperatureUnit.pm,v 1.3 2002/06/17 21:11:41 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::Measurement::TemperatureUnit
...
=head2 SYNOPSIS
  ...
  my $temperatureunit = Bio::MAGE::Measurement::TemperatureUnit->new(unitNameCV=>$unitNameCV_value);

    # setting and retrieving object attributes
  my $unitNameCV_val = $temperatureunit->unitNameCV();
  $temperatureunit->unitNameCV($value);


=head2 DESCRIPTION

From the MAGE-OM documentation for the C<TemperatureUnit> class:
...
Bio::MAGE::Measurement::TemperatureUnit has the following super classes
...
instance of the class via the Bio::MAGE::Measurement::TemperatureUnit->methodname() syntax.
...
Sets the value of the unitNameCV attribute (from C<Bio::MAGE::Measurement::TemperatureUnit>).
...
Returns the full class name for this class, Bio::MAGE::Measurement::TemperatureUnit.

=cut

sub class_name {
  return q[Bio::MAGE::Measurement::TemperatureUnit];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::Measurement::TemperatureUnit.
...
Bio::MAGE::Measurement::TemperatureUnit: has the following attribute accessor methods:
...
=item $val = $temperatureunit->setUnitNameCV($val)
...
=item $val = $temperatureunit->getUnitNameCV()
