...
$VERSION = q[$Id: ConcentrationUnit.pm,v 1.3 2002/06/17 21:11:41 jason_e_stewart Exp $];
...
Sets the value of the unitNameCV attribute (from C<Bio::MAGE::Measurement::ConcentrationUnit>).
