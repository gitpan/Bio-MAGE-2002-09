...
#
##############################
package Bio::MAGE::Measurement::VolumeUnit;
...
$VERSION = q[$Id: VolumeUnit.pm,v 1.3 2002/06/17 21:11:41 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::Measurement::VolumeUnit
...
=head2 SYNOPSIS
  ...
  my $volumeunit = Bio::MAGE::Measurement::VolumeUnit->new(unitNameCV=>$unitNameCV_value);

    # setting and retrieving object attributes
  my $unitNameCV_val = $volumeunit->unitNameCV();
  $volumeunit->unitNameCV($value);


=head2 DESCRIPTION

From the MAGE-OM documentation for the C<VolumeUnit> class:
...
Bio::MAGE::Measurement::VolumeUnit has the following super classes
...
instance of the class via the Bio::MAGE::Measurement::VolumeUnit->methodname() syntax.
...
Sets the value of the unitNameCV attribute (from C<Bio::MAGE::Measurement::VolumeUnit>).
...
Returns the full class name for this class, Bio::MAGE::Measurement::VolumeUnit.

=cut

sub class_name {
  return q[Bio::MAGE::Measurement::VolumeUnit];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::Measurement::VolumeUnit.
...
Bio::MAGE::Measurement::VolumeUnit: has the following attribute accessor methods:
...
=item $val = $volumeunit->setUnitNameCV($val)
...
=item $val = $volumeunit->getUnitNameCV()
