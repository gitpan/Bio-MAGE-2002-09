...
$VERSION = q[$Id: DistanceUnit.pm,v 1.3 2002/06/17 21:11:41 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::Measurement::DistanceUnit
...
=head2 SYNOPSIS
  ...
  my $distanceunit = Bio::MAGE::Measurement::DistanceUnit->new(unitNameCV=>$unitNameCV_value);

    # setting and retrieving object attributes
  my $unitNameCV_val = $distanceunit->unitNameCV();
  $distanceunit->unitNameCV($value);
...
Bio::MAGE::Measurement::DistanceUnit has the following super classes
...
Returns the full class name for this class, Bio::MAGE::Measurement::DistanceUnit.

=cut

sub class_name {
  return q[Bio::MAGE::Measurement::DistanceUnit];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::Measurement::DistanceUnit.
...
Bio::MAGE::Measurement::DistanceUnit: has the following attribute accessor methods:
