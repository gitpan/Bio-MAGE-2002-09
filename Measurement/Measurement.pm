...
$VERSION = q[$Id: Measurement.pm,v 1.7 2002/10/13 21:56:09 jason_e_stewart Exp $];
...
sub classes {
  return ('Measurement', 'Unit', 'TimeUnit', 'DistanceUnit', 'TemperatureUnit', 'QuantityUnit', 'MassUnit', 'VolumeUnit', 'ConcentrationUnit');
}
