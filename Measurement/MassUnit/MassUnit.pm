...
#
##############################
package Bio::MAGE::Measurement::MassUnit;
...
$VERSION = q[$Id: MassUnit.pm,v 1.3 2002/06/17 21:11:41 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::Measurement::MassUnit
...
=head2 SYNOPSIS
  ...
  my $massunit = Bio::MAGE::Measurement::MassUnit->new(unitNameCV=>$unitNameCV_value);

    # setting and retrieving object attributes
  my $unitNameCV_val = $massunit->unitNameCV();
  $massunit->unitNameCV($value);


=head2 DESCRIPTION

From the MAGE-OM documentation for the C<MassUnit> class:
...
Bio::MAGE::Measurement::MassUnit has the following super classes
...
instance of the class via the Bio::MAGE::Measurement::MassUnit->methodname() syntax.
...
Sets the value of the unitNameCV attribute (from C<Bio::MAGE::Measurement::MassUnit>).
...
Returns the full class name for this class, Bio::MAGE::Measurement::MassUnit.

=cut

sub class_name {
  return q[Bio::MAGE::Measurement::MassUnit];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::Measurement::MassUnit.
...
Bio::MAGE::Measurement::MassUnit: has the following attribute accessor methods:
...
=item $val = $massunit->setUnitNameCV($val)
...
=item $val = $massunit->getUnitNameCV()
