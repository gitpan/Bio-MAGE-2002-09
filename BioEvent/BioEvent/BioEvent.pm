...
#
##############################
package Bio::MAGE::BioEvent::BioEvent;
...
$VERSION = q[$Id: BioEvent.pm,v 1.4 2002/08/24 16:12:17 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::BioEvent::BioEvent
...
=head2 SYNOPSIS
  ...
  my $bioevent = Bio::MAGE::BioEvent::BioEvent->new(protocolApplications=>$protocolApplications_value);

    # setting and retrieving object associations
  my $protocolApplications_val = $bioevent->protocolApplications();
  $bioevent->protocolApplications($value);


=head2 DESCRIPTION

From the MAGE-OM documentation for the C<BioEvent> class:
...
Bio::MAGE::BioEvent::BioEvent has the following super classes
...
Bio::MAGE::BioEvent::BioEvent has the following subclasses

=over 


=item * Bio::MAGE::BioAssay::BioAssayCreation


=item * Bio::MAGE::BioAssayData::Transformation


=item * Bio::MAGE::BioEvent::Map


=item * Bio::MAGE::BioAssay::FeatureExtraction


=item * Bio::MAGE::BioMaterial::Treatment
...
instance of the class via the Bio::MAGE::BioEvent::BioEvent->methodname() syntax.
...
Returns the full class name for this class, Bio::MAGE::BioEvent::BioEvent.

=cut

sub class_name {
  return q[Bio::MAGE::BioEvent::BioEvent];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::BioEvent::BioEvent.
...
Bio::MAGE::BioEvent::BioEvent: has the following attribute accessor methods:
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The applied protocols to the BioEvent.',
                   '__ORDERED' => 0
...
Bio::MAGE::BioEvent::BioEvent: has the following association accessor methods:
...
sub initialize {
  carp "Bio::MAGE::BioEvent::BioEvent::initialize: abstract base classes should not be instantiated";
}
