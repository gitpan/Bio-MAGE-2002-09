...
$VERSION = q[$Id: Map.pm,v 1.4 2002/08/24 16:12:17 jason_e_stewart Exp $];
...
sub subclasses {
  my @list = ('Bio::MAGE::BioAssayData::BioAssayMap', 'Bio::MAGE::BioAssayData::QuantitationTypeMap', 'Bio::MAGE::BioAssayData::DesignElementMap');
  return @list;
}
