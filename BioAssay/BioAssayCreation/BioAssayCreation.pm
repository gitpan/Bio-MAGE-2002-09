...
$VERSION = q[$Id: BioAssayCreation.pm,v 1.4 2002/08/24 16:12:14 jason_e_stewart Exp $];
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The BioSample and its amount used in the BioAssayCreation event.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__CLASS_NAME' => 'Array',
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'The array used in the BioAssayCreation event.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
