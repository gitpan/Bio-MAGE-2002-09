...
$VERSION = q[$Id: Channel.pm,v 1.4 2002/08/24 16:12:14 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::BioAssay::Channel
...
=head2 SYNOPSIS
  ...
  my $channel = Bio::MAGE::BioAssay::Channel->new(labels=>$labels_value);

    # setting and retrieving object associations
  my $labels_val = $channel->labels();
...
Bio::MAGE::BioAssay::Channel has the following super classes
...
Sets the value of the labels association (from C<Bio::MAGE::BioAssay::Channel>).
...
Returns the full class name for this class, Bio::MAGE::BioAssay::Channel.

=cut

sub class_name {
  return q[Bio::MAGE::BioAssay::Channel];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::BioAssay::Channel.
...
Bio::MAGE::BioAssay::Channel: has the following attribute accessor methods:
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The compound used to label the extract.',
                   '__ORDERED' => 0
