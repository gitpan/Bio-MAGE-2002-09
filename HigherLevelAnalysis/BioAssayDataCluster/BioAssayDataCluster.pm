...
$VERSION = q[$Id: BioAssayDataCluster.pm,v 1.4 2002/08/24 16:12:21 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::HigherLevelAnalysis::BioAssayDataCluster
...
Bio::MAGE::HigherLevelAnalysis::BioAssayDataCluster has the following super classes
...
Returns the full class name for this class, Bio::MAGE::HigherLevelAnalysis::BioAssayDataCluster.

=cut

sub class_name {
  return q[Bio::MAGE::HigherLevelAnalysis::BioAssayDataCluster];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::HigherLevelAnalysis::BioAssayDataCluster.
...
Bio::MAGE::HigherLevelAnalysis::BioAssayDataCluster: has the following attribute accessor methods:
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The BioAssayData whose values were used by the cluster algorithm.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__CLASS_NAME' => 'Node',
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'The nodes of the cluster.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
...
=item $bioassaydatacluster->addNodes(@vals)
