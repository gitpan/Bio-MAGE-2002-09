...
$VERSION = q[$Id: NodeValue.pm,v 1.4 2002/08/24 16:12:21 jason_e_stewart Exp $];
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The type of value, distance, etc.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__CLASS_NAME' => 'OntologyEntry',
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'The scale (linear, log10, ln, etc.) of the value.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'dataType',
          bless( {
                   ...
                   '__CLASS_NAME' => 'OntologyEntry',
                   '__RANK' => '3',
                   '__DESCRIPTION' => 'The data type of the any element.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
