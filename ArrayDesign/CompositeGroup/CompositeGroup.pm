...
$VERSION = q[$Id: CompositeGroup.pm,v 1.4 2002/08/24 16:12:12 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::ArrayDesign::CompositeGroup
...
=head2 SYNOPSIS
  ...
  my $compositegroup = Bio::MAGE::ArrayDesign::CompositeGroup->new(compositeSequences=>$compositeSequences_value);

    # setting and retrieving object associations
  my $compositeSequences_val = $compositegroup->compositeSequences();
  $compositegroup->compositeSequences($value);
...
Bio::MAGE::ArrayDesign::CompositeGroup has the following super classes
...
Sets the value of the compositeSequences association (from C<Bio::MAGE::ArrayDesign::CompositeGroup>).
...
Returns the full class name for this class, Bio::MAGE::ArrayDesign::CompositeGroup.

=cut

sub class_name {
  return q[Bio::MAGE::ArrayDesign::CompositeGroup];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::ArrayDesign::CompositeGroup.
...
Bio::MAGE::ArrayDesign::CompositeGroup: has the following attribute accessor methods:
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The compositeSequences that belong to this group.',
                   '__ORDERED' => 0
...
=item $compositegroup->addCompositeSequences(@vals)
