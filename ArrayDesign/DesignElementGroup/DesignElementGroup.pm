...
#
##############################
package Bio::MAGE::ArrayDesign::DesignElementGroup;
...
$VERSION = q[$Id: DesignElementGroup.pm,v 1.4 2002/08/24 16:12:12 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::ArrayDesign::DesignElementGroup
...
=head2 SYNOPSIS
  ...
  my $designelementgroup = Bio::MAGE::ArrayDesign::DesignElementGroup->new(types=>$types_value,
			species=>$species_value);

    # setting and retrieving object associations
  my $types_val = $designelementgroup->types();
  $designelementgroup->types($value);

  my $species_val = $designelementgroup->species();
  $designelementgroup->species($value);


=head2 DESCRIPTION

From the MAGE-OM documentation for the C<DesignElementGroup> class:
...
Bio::MAGE::ArrayDesign::DesignElementGroup has the following super classes
...
Bio::MAGE::ArrayDesign::DesignElementGroup has the following subclasses

=over 


=item * Bio::MAGE::ArrayDesign::CompositeGroup


=item * Bio::MAGE::ArrayDesign::ReporterGroup


=item * Bio::MAGE::ArrayDesign::FeatureGroup
...
instance of the class via the Bio::MAGE::ArrayDesign::DesignElementGroup->methodname() syntax.
...
Returns the full class name for this class, Bio::MAGE::ArrayDesign::DesignElementGroup.

=cut

sub class_name {
  return q[Bio::MAGE::ArrayDesign::DesignElementGroup];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::ArrayDesign::DesignElementGroup.
...
sub subclasses {
  my @list = ('Bio::MAGE::ArrayDesign::CompositeGroup', 'Bio::MAGE::ArrayDesign::ReporterGroup', 'Bio::MAGE::ArrayDesign::FeatureGroup');
  return @list;
}
...
Bio::MAGE::ArrayDesign::DesignElementGroup: has the following attribute accessor methods:
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The specific type of a feature, reporter, or composite.  A composite type might be a gene while a reporter type might be a cDNA clone or an oligo.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__CLASS_NAME' => 'OntologyEntry',
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'The organism from which the biosequences of this group are from.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
...
Bio::MAGE::ArrayDesign::DesignElementGroup: has the following association accessor methods:
...
sub initialize {
  carp "Bio::MAGE::ArrayDesign::DesignElementGroup::initialize: abstract base classes should not be instantiated";
}
