...
$VERSION = q[$Id: BQS.pm,v 1.7 2002/10/13 21:56:04 jason_e_stewart Exp $];
...
=item $obj_ref = Bio::MAGE::BQS->new(%parameters)
...
=item $val = $bqs->mageml_lists()

=item $val = $bqs->mageml_lists($val)
