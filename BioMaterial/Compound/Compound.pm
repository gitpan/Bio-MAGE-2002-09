...
$VERSION = q[$Id: Compound.pm,v 1.4 2002/08/24 16:12:17 jason_e_stewart Exp $];
...
Sets the value of the isSolvent attribute (from C<Bio::MAGE::BioMaterial::Compound>).


=item * componentCompounds

Sets the value of the componentCompounds association (from C<Bio::MAGE::BioMaterial::Compound>).


=item * externalLIMS

Sets the value of the externalLIMS association (from C<Bio::MAGE::BioMaterial::Compound>).


=item * merckIndex

Sets the value of the merckIndex association (from C<Bio::MAGE::BioMaterial::Compound>).
...
sub association_methods {
  my $class = shift;
  my @list = ('componentCompounds', 'externalLIMS', 'merckIndex');
  if ($class->superclasses()) {
    foreach ($class->superclasses()) {
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'The Merck Index of this Compound.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'The Compounds and their amounts used to create this Compound.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'externalLIMS',
          bless( {
                   ...
                   '__RANK' => '3',
                   '__DESCRIPTION' => 'Reference to an entry in an external LIMS data source.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
