...
#
##############################
package Bio::MAGE::BioMaterial::CompoundMeasurement;
...
$VERSION = q[$Id: CompoundMeasurement.pm,v 1.4 2002/08/24 16:12:17 jason_e_stewart Exp $];
...
=head1 Bio::MAGE::BioMaterial::CompoundMeasurement
...
From the MAGE-OM documentation for the C<CompoundMeasurement> class:
...
Returns the full class name for this class, Bio::MAGE::BioMaterial::CompoundMeasurement.

=cut

sub class_name {
  return q[Bio::MAGE::BioMaterial::CompoundMeasurement];
}

=item $package_name = package()

Returns the unresolved package name (i.e. no 'Bio::MAGE::') of the
package that contains class, Bio::MAGE::BioMaterial::CompoundMeasurement.
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'A Compound to be used to create another Compound.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'The amount of the Compound.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
...
From the MAGE-OM documentation for the C<compound> association:
...
=item $val = $compoundmeasurement->setCompound($val)

The restricted setter method for the compound association.

Input parameters: the value to which the compound association will be set : an instance of type C<Bio::MAGE::BioMaterial::Compound>.

Return value: the current value of the compound association : an instance of type C<Bio::MAGE::BioMaterial::Compound>.

Side effects: none

Exceptions: will call C<croak()> if no input parameters are specified, or
if too many input parameters are specified , or if $val is not an instance of class C<Bio::MAGE::BioMaterial::Compound>

=cut

sub setCompound {
  my $self = shift;
  croak(__PACKAGE__ . "::setCompound: no arguments passed to setter")
    unless @_;
  croak(__PACKAGE__ . "::setCompound: too many arguments passed to setter")
    if @_ > 1;
  my $val = shift;
  croak(__PACKAGE__ . "::setCompound: wrong type: " . ref($val) . " expected Bio::MAGE::BioMaterial::Compound") unless UNIVERSAL::isa($val,'Bio::MAGE::BioMaterial::Compound');
  return $self->{__COMPOUND} = $val;
}



=item $val = $compoundmeasurement->getCompound()

The restricted getter method for the compound association.
