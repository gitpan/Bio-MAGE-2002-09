...
$VERSION = q[$Id: BioMaterialMeasurement.pm,v 1.4 2002/08/24 16:12:17 jason_e_stewart Exp $];
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'A source BioMaterial for a treatment.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'The amount of the BioMaterial.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
