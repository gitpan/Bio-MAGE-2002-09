...
$VERSION = q[$Id: DesignElement.pm,v 1.4 2002/08/24 16:12:19 jason_e_stewart Exp $];
...
=head2 SYNOPSIS
  ...
  my $designelement = Bio::MAGE::DesignElement::DesignElement->new(controlType=>$controlType_value);
...
sub subclasses {
  my @list = ('Bio::MAGE::DesignElement::Reporter', 'Bio::MAGE::DesignElement::CompositeSequence', 'Bio::MAGE::DesignElement::Feature');
  return @list;
}
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'If the design element represents a control, the type of control it is (normalization, deletion, negative, positive, etc.)',
                   '__ORDERED' => 0
