...
$VERSION = q[$Id: BioSequence.pm,v 1.7 2002/10/13 21:56:05 jason_e_stewart Exp $];
...
BEGIN {
  $__ASSOCIATIONS = [
          ...
          bless( {
                   ...
                   '__RANK' => '1',
                   '__DESCRIPTION' => 'References an entry in a species database, like GenBank, UniGene, etc.',
                   '__ORDERED' => 0
          ...
          bless( {
                   ...
                   '__RANK' => '2',
                   '__DESCRIPTION' => 'Ontology entries referring to common values associated with BioSequences, such as gene names, go ids, etc.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'polymerType',
          bless( {
                   ...
                   '__CLASS_NAME' => 'OntologyEntry',
                   '__RANK' => '3',
                   '__DESCRIPTION' => 'A choice of protein, RNA, or DNA.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'type',
          bless( {
                   ...
                   '__CLASS_NAME' => 'OntologyEntry',
                   '__RANK' => '4',
                   '__DESCRIPTION' => 'The type of biosequence, i.e. gene, exon, UniGene cluster, fragment, BAC, EST, etc.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'species',
          bless( {
                   ...
                   '__CLASS_NAME' => 'OntologyEntry',
                   '__RANK' => '5',
                   '__DESCRIPTION' => 'The organism from which this sequence was obtained.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' ),
          'seqFeatures',
          bless( {
                   ...
                   '__RANK' => '6',
                   '__DESCRIPTION' => 'Association to annotations for subsequences.  Corresponds to the GenBank Frame Table.',
                   '__ORDERED' => 0
                 }, 'Bio::MAGE::Association' )
        ]
